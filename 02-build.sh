...
rm -rf /opt/k8s-spring-cloud-parent/eureka-server/docker-k8s/*.jar

mvn clean install -DskipTests=true



cd /opt/k8s-spring-cloud-parent/eureka-server/docker-k8s

rm -rf *.jar
cp /opt/k8s-spring-cloud-parent/eureka-server/target/eureka-server.jar .
...
microk8s.kubectl delete  -f /opt/k8s-spring-cloud-parent/eureka-server/docker-k8s/k8s.yaml 
...
microk8s.kubectl apply  -f /opt/k8s-spring-cloud-parent/eureka-server/docker-k8s/k8s.yaml 
